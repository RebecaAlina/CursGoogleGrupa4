...
inmultire = Button(frame_button, text='*', fg='black', width=16, height=3, bd=1, bg='#eee', cursor='hand2',
...
minus = Button(frame_button, text='-', fg='black', width=16, height=3, bd=1, bg='#eee', cursor='hand2',
...
plus = Button(frame_button, text='+', fg='black', width=16, height=3, bd=1, bg='#eee', cursor='hand2',
...
egal = Button(frame_button, text='=', fg='black', width=16, height=3, bd=1, bg='#eee', cursor='hand2',
